<header class="bg-orange-500 text-teal-50 mb-2">
    <div class="mx-auto w-11/12 md:w-2/3 px-2 py-3">
        <div class="flex flex-col lg:flex-row justify-between items-center gap-4">
            <div class="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full lg:w-auto">
                <a href="/" class="font-semibold flex items-center gap-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 sm:h-12" viewBox="0 0 640 640">
                    ...
                    <span class="text-xl sm:text-2xl">BoNiaTo</span>
                </a>

                <nav class="flex gap-x-2 sm:gap-x-3 items-center">
                    <a href="{{route('articles.index')}}" class="hover:bg-orange-400 hover:text-[#26054D] p-1 px-2 rounded-xl text-sm sm:text-base">Articles</a>
                    <span class="text-[#26054D] hidden sm:inline">|</span>
                    <a href="{{route('categories.index')}}" class="hover:bg-orange-400 hover:text-[#26054D] p-1 px-2 rounded-xl text-sm sm:text-base">Categories</a>
                    <span class="text-[#26054D] hidden sm:inline">|</span>
                    <a href="{{route('authors.index')}}" class="hover:bg-orange-400 hover:text-[#26054D] p-1 px-2 rounded-xl text-sm sm:text-base">Authors</a>
                </nav>
            </div>
                ...
                @if (Route::has('login'))
                    <nav class="flex items-center justify-end gap-2 sm:gap-4">
                        @auth
                            <a
                                href="{{ url('/dashboard') }}"
                                class="inline-block px-3 sm:px-5 py-1.5 border-[#26054D] hover:bg-[#26054D] hover:text-white hover:border-[#26054D] border text-[#26054D] dark:border-[#3E3E3A] dark:hover:border-[#62605b] rounded-sm text-xs sm:text-sm leading-normal"
                            >
                                Dashboard
                            </a>
                        @else
                            <a
                                href="{{ route('login') }}"
                                class="inline-block px-3 sm:px-5 py-1.5 dark:text-[#EDEDEC] text-[#1b1b18] border border-transparent hover:border-[#19140035] dark:hover:border-[#3E3E3A] rounded-sm text-xs sm:text-sm leading-normal"
                            >
                                Log in
                            </a>
